...
else
{
	...
	if(isset($_POST['username'], $_POST['password']))
	{
		...
		{
			$ousername = stripslashes($conn, $_POST['username']);
			$username = mysqli_real_escape_string(stripslashes($conn, $_POST['username']));
			$password = stripslashes($conn, $_POST['password']);
		}
		else
		{
...
<div class="content">
<?php
$nb_new_pm = mysqli_fetch_array(mysqli_query($conn,'select count(*) as nb_new_pm from pm where ((user1="'.$_SESSION['userid'].'" and user1read="no") and or (user2="'.$_SESSION['userid'].'" and user2read="no")) and id2="1"'));
...
<div class="box">
	...
	<div class="box_right">
    	<a href="list_pm.php">Vos messages(<?php echo $nb_new_pm; ?>)</a> - <a href="profile.php?id=<?php echo $_SESSION['id']; ?>"><?php echo htmlentities($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?></a> (<a href="login.php">Déconnexion</a>)
    </div>
    <div class="clean"></div>
</div>
...
?>
		<div class="foot"><a href="http://www.supportduweb.com/scripts_tutoriaux-code-source-89-simple-php-forum-script-forum-en-php-facile-simple-script-code-telecharger-forum-php-gratuit-mysqli.html">Simple PHP Forum Script</a> - <a href="http://www.supportduweb.com/">Support du Web</a></div>
	</body>
</html>